const testimonials = [
	{
		...
		quote:
			"Gift Easy helped me find the perfect anniversary gift for my wife. She absolutely loved it!",
		name: "Michael T.",
		role: "Happy Customer",
	...
	},
	{
		...
		quote:
			"I was struggling to find a unique birthday gift until I used Gift Easy. The AI recommendations were spot-on!",
		name: "Sarah K.",
		role: "Satisfied User",
	...
	},
	{
		...
		quote:
			"Worth every penny! Found an amazing graduation gift that I never would have thought of myself.",
		name: "David L.",
		role: "Regular User",
		avatar: "/images/avatar-placeholder.png",
	},
	...
	return (
		...
		>
			<h2
				...
				className="text-3xl font-bold text-center mb-12 text-zinc-800"
			>
				What Our Users Say
			</h2>
			...
			<div className="grid md:grid-cols-3 gap-8">
				{testimonials.map((testimonial) => (
					<div
						key={testimonial.id}
						className="bg-white/5 p-6 rounded-xl backdrop-blur-sm flex flex-col"
					>
						<div className="flex-grow">
							<p className="italic text-zinc-800/90 mb-4">
								"{testimonial.quote}"
							</p>
						</div>
